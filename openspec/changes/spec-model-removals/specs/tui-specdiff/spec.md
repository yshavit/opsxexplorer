...
#### Scenario: the removal note is styled as inserted, not deleted
- **WHEN** a removal-note row is rendered
- **THEN** it carries the added gutter marker and the insertion styling used for newly added text, distinct from the deletion styling of the intro and scenario rows below it
