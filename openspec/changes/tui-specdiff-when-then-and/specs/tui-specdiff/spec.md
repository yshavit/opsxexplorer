...
- FROM: `### Requirement: WHEN/THEN bullet keywords render without markdown asterisks`
- TO: `### Requirement: WHEN/THEN/AND bullet keywords render without markdown asterisks`
