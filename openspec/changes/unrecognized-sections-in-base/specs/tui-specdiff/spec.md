...
- **THEN** the pane renders an unstyled "Other sections" heading with an italic second line noting they are in the spec of record but not this change, followed by one collapsed-by-default row per section, each showing that section's title
